package com.neuromind.neuromind.shared.medicalRecords.util;
...
import com.neuromind.neuromind.shared.medicalRecords.exceptions.FileWriteException;
import com.neuromind.neuromind.shared.medicalRecords.exceptions.GCPFileUploadException;
import com.neuromind.neuromind.shared.medicalRecords.exceptions.InvalidFileTypeException;
...
public class DataBucketUtil {
    ...
    public RecordFilesDTO uploadFile(MultipartFile multipartFile, String fileName, String contentType) {
        try{
            ...
            if(blob != null){
                ...
                return new RecordFilesDTO(blob.getName(), blob.getMediaLink());
            }
